...
\newcommand{\myfigureold}[3]{
	\begin{figure}[tbp]
		...
		\vskip -0.14in
	\end{figure}
} % changed by saeed was -0.14 changed to -0.01in
\newcommand{\mytabfig}[3]{
	\begin{figure}[tbp]
  		\begin{center}
   			\fbox{
    				\begin{minipage}[t]{5.7in}
...
\acrodefplural{WSN}[WSN's]{Wireless Sensor Networks}
\acrodef{SL-coloring}{Smallest-last coloring}
\acrodef{SL-ordering}{Smallest-last ordering}
\acrodef{RGG}{Random Geometric Graph}
\acrodefplural{RGG}[RGG's]{Random Geometric Graphs}
\acrodef{MEMS}{Microelectromechanical Systems}
\acrodef{SOSUS}{Sound Surveillance System}
